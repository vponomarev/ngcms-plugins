...
$cfgX = array();
array_push($cfgX, array('name' => 'cache', 'title' => "»спользовать кеширование данных<br /><small><b>ƒа</b> - кеширование используетс€<br /><b>Ќет</b> - кеширование не используетс€</small>", 'type' => 'select', 'values' => array ( '1' => 'ƒа', '0' => 'Ќет'), 'value' => intval(extra_get_param($plugin,'cache'))));
array_push($cfgX, array('name' => 'cacheExpire', 'title' => "ѕериод обновлени€ кеша<br /><small>(через сколько секунд происходит обновление кеша. «начение по умолчанию: <b>60</b>)</small>", 'type' => 'input', 'value' => intval(extra_get_param($plugin,'cacheExpire'))?extra_get_param($plugin,'cacheExpire'):'60'));
