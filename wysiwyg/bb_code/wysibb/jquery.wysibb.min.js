...
cmd: function() {
try{document.forms['DATA_tmp_storage'].area.value=currentInputAreaId;} catch(err){;}
window.open('admin.php?mod=images&ifield=' + currentInputAreaID, '_Addimage', 'height=600,resizable=yes,scrollbars=yes,width=800');
return false;
},
},
bullist : {
