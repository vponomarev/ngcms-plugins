...
$lang = array(
    ...
    "The uploaded file exceeds {size} bytes." => "El archivo excede el tamaР“В±o permitido ({size} bytes).",
    "The uploaded file was only partially uploaded." => "El archivo solo fuР“В© parcialmente cargado.",
    "No file was uploaded." => "El archivo no fuР“В© cargado.",
    "Missing a temporary folder." => "No se puede encontrar el directorio temporal.",
    "Failed to write file." => "No se pudo crear el archivo.",
    "Denied file extension." => "ExtensiР“С–n de archivo denegada.",
    "Unknown image format/encoding." => "Formato / codificaciР“С–n de imagen desconocido.",
    ...
    "Incorrect .htaccess file. Cannot rewrite it!" => "Archivo .htaccess incorrecto. Р’РЋNo puede sobreescribirlo!",
    ...
    "Unallowable characters in folder name." => "Caracteres invР“РЋlidos en el nombre de carpeta.",
    ...
    "Unallowable characters in file name." => "CarР“РЋcteres invР“РЋlidos en el nombre de archivo.",
    ...
    "Fileinfo PECL extension is missing." => "Archivo PECL con estructura errР“С–nea.",
    "Opening fileinfo database failed." => "Error abriendo el archivo de informaciР“С–n de la base de datos.",
    ...
    "This file is already added to the Clipboard." => "Este archivo ya fuР“В© agregado al portapapeles.",
    ...
    "Failed to delete {count} files/folders." => "FallР“С– al borrar {count} archivos/carpetas.",
    "A file or folder with that name already exists." => "Existe una carpeta o archivo con el mismo nombre.",
    "Copy files here" => "Copiar archivos aquР“В­",
    "Move files here" => "Mover archivos aquР“В­",
    ...
    "Unable to connect!" => "Р’РЋNo se pudo realizar la conexiР“С–n!",
    "Download version {version} now!" => "Р’РЋDescarga la versiР“С–n {version} ahora!",
    "KCFinder is up to date!" => "Р’РЋKCFinder estР“РЋ actualizado!",
    "Licenses:" => "Licencias:",
    "Attention" => "AtenciР“С–n",
    "Question" => "Pregunta",
    "Yes" => "Si",
    "No" => "No",
    "You cannot rename the extension of files!" => "Р’РЋUsted no puede renombrar la extensiР“С–n de los archivos!",
    "Uploading file {number} of {count}... {progress}" => "Cargando archivo {number} de {count}... {progress}",
    "Failed to upload {filename}!" => "Р’РЋNo se pudo cargar el archivo {filename}!",
);
