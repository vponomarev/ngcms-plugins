...
$lang = array(
    ...
    "The uploaded file was only partially uploaded." => "Il file Р“РЃ stato caricato parzialmente.",
    "No file was uploaded." => "Nessun file Р“РЃ stato caricato",
    ...
    "Unknown image format/encoding." => "Il format/encoding dell'immagine Р“РЃ sconosciuto.",
    "The image is too big and/or cannot be resized." => "L'immagine Р“РЃ troppo grande e/o non puР“Р† essere rimpicciolita",
    "Cannot create {dir} folder." => "La cartella {dir} non puР“Р† essere creata.",
    "Cannot rename the folder." => "Non Р“РЃ possibile rinominare la cartella.",
    ...
    "Incorrect .htaccess file. Cannot rewrite it!" => "Il file .htaccess Р“РЃ corrotto. Impossibile riscriverlo!",
    ...
    "Folder name shouldn't begins with '.'" => "Il nome della cartella non puР“Р† iniziare con'.'",
    ...
    "File name shouldn't begins with '.'" => "Il nome del file non puР“Р† iniziare con '.'",
    ...
    "You can't upload such files." => "Non Р“РЃ possibile caricare questi files.",
    ...
    "Cannot delete the folder." => "Non Р“РЃ possibile cancellare la cartella.",
    "Click to remove from the Clipboard" => "Click per rimuoverlo dalla Clipboard",
    "This file is already added to the Clipboard." => "Questo file Р“РЃ giР“В  stato aggiunto alla Clipboard.",
    ...
    "The selected files are not removable." => "Il file selezionato non Р“РЃ rimovibile.",
    ...
    "A file or folder with that name already exists." => "Un file o cartella con questo nome giР“В  esiste.",
    ...
    "Inexistant or inaccessible folder." => "La cartella non esiste o Р“РЃ inacessibile.",
    ...
    "KCFinder is up to date!" => "KCFinder Р“РЃ aggiornato!",
    "Licenses:" => "Licenze:",
    ...
    "Failed to upload {filename}!" => "Il caricamento del file {filename} Р“РЃ fallito ",
    "Close" => "Chiudi",
    "Previous" => "Precedente",
    "Next" => "Successivo",
