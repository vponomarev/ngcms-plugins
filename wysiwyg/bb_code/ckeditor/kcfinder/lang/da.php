...
$lang = array(
    ...
    "Denied file extension." => "NР“В¦gtet filtypenavn.",
    "Unknown image format/encoding." => "Ukendt billedformat / kodning.",
    "The image is too big and/or cannot be resized." => "Billedet er for stort og / eller kan ikke Р“В¦ndres.",
    "Cannot create {dir} folder." => "Kan ikke lave mappen {dir}.",
    "Cannot rename the folder." => "Kan ikke omdР“С‘be mappen.",
    "Cannot write to upload folder." => "Kan ikke skrive til upload mappen.",
    "Cannot read .htaccess" => "Ikke kan lР“В¦se .htaccess",
    "Incorrect .htaccess file. Cannot rewrite it!" => "Forkert .htaccess fil. Kan ikke omskrive den!",
    "Cannot read upload folder." => "Kan ikke lР“В¦se upload mappen.",
    "Cannot access or create thumbnails folder." => "Kan ikke fР“Тђ adgang til eller oprette miniature mappe.",
    "Cannot access or write to upload folder." => "Kan ikke fР“Тђ adgang til eller skrive til upload mappe.",
    ...
    "Folder name shouldn't begins with '.'" => "Mappenavne bР“С‘r ikke begynde med '.'",
    "Please enter new file name." => "Indtast venligst nyt filnavn.",
    "Unallowable characters in file name." => "Ugyldige tegn i filens navn",
    "File name shouldn't begins with '.'" => "Filnavn bР“С‘r ikke begynde med '.'",
    "Are you sure you want to delete this file?" => "Er du sikker pР“Тђ du vil slette denne fil?",
    "Are you sure you want to delete this folder and all its content?" => "Er du sikker pР“Тђ du vil slette denne mappe og al dens indhold?",
    ...
    "Opening fileinfo database failed." => "Р“вЂ¦bning af filinfo database mislykkedes.",
    "You can't upload such files." => "Du kan ikke uploade sР“Тђdanne filer.",
    "The file '{file}' does not exist." => "Filen '{file}' eksisterer ikke.",
    "Cannot read '{file}'." => "Kan ikke lР“В¦se '{file}'.",
    ...
    "This file is already added to the Clipboard." => "Denne fil er allerede fР“С‘jet til udklipsholderen.",
    "The files in the Clipboard are not readable." => "Filerne i udklipsholderen ikke kan lР“В¦ses.",
    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" => "{count} filer i udklipsholderen ikke kan lР“В¦ses. Р“пїЅnsker du at kopiere resten?",
    "The files in the Clipboard are not movable." => "Filerne i udklipsholderen kan ikke flyttes.",
    "{count} files in the Clipboard are not movable. Do you want to move the rest?" => "{count} filer i udklipsholderen er ikke flytbare. Р“пїЅnsker du at flytte resten?",
    "The files in the Clipboard are not removable." => "Filerne i udklipsholderen kan ikke fjernes.",
    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" => "{count} filer i udklipsholderen kan ikke fjernes. Р“пїЅnsker du at slette resten?",
    "The selected files are not removable." => "De valgte filer er ikke flytbare.",
    "{count} selected files are not removable. Do you want to delete the rest?" => "{count} valgte filer kan ikke fjernes. Р“пїЅnsker du at slette resten?",
    "Are you sure you want to delete all selected files?" => "Er du sikker pР“Тђ du vil slette alle markerede filer?",
    ...
    "Clear the Clipboard" => "TР“С‘m udklipsholderen",
    "Are you sure you want to delete all files in the Clipboard?" => "TР“С‘m udklipsholderen?",
    "Copy {count} files" => "Kopier {count} filer",
    "Move {count} files" => "Flyt {count} filer",
    "Add to Clipboard" => "TilfР“С‘j til udklipsholderen",
    "Inexistant or inaccessible folder." => "Manglende eller utilgР“В¦ngelig mappe.",
    ...
    "Loading image..." => "IndlР“В¦ser billede...",
    "Loading folders..." => "IndlР“В¦ser mapper...",
    "Loading files..." => "IndlР“В¦ser filer...",
    ...
    "Cancel" => "Fortryd",
    "Select" => "VР“В¦lg",
    "Select Thumbnail" => "VР“В¦lg miniature",
    "Select Thumbnails" => "VР“В¦lg miniaturer",
    "View" => "Р“вЂ¦ben",
    "Download" => "Download",
    "Download files" => "Download filer",
    "Clipboard" => "Udklipsholder",
    "Checking for new version..." => "SР“С‘ger efter ny version...",
    ...
    "Licenses:" => "Licenser:",
    "Attention" => "Vigtigt",
    "Question" => "SpР“С‘rgsmР“Тђl",
    "Yes" => "Ja",
    "No" => "Nej",
    "You cannot rename the extension of files!" => "Du kan ikke Р“В¦ndre typen pР“Тђ filer!",
