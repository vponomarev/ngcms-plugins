...
array_push($cfgX, array('name' => 'allow_text', 'title' => "Разрешить добавлять текстовое сообщение к отчёту об ошибке", 'descr' => "<b>Нет</b> - добавление текста запрещено<br/><b>Только зарегистрированные</b> - текст могут добавлять только зарегистрированные пользователи<br/><b>Да</b> - текст могут добавлять все", 'type' => 'select', 'values' => array ( '0' => 'Нет', '1' => 'Только зарегистрированные', '2' => 'Да'), 'value' => intval(extra_get_param($plugin,'allow_text'))));
