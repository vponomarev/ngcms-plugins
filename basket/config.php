...
$cfg = array();
array_push($cfg, array('descr' => 'Плагин реализует функционал "корзины товаров"'));
...
$cfgX = array();
array_push($cfgX, array('name' => 'ntable_flag', 'type' => 'select', 'title' => 'Включить корзину для элементов каталога', 'descr' => '<b>Да</b> - корзина будет активна для элементов каталога<br/><b>Нет</b> - корзина не будет активна для элементов каталога', 'values' => array ( 0 => 'Нет', 1 => 'Да'), value => pluginGetVariable('basket','ntable_flag')));
...
array_push($cfg,  array('mode' => 'group', 'title' => '<b>Работа с таблицами новостей</b>', 'entries' => $cfgX));
