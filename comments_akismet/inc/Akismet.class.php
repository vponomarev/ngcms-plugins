 ...
 *
 * Please note that in order to use this class, you must have a vaild {@link http://wordpress.com/api-keys/ API key}.  They are free for non/small-profit types and getting one will only take a couple of minutes.
 *
 ...
 * </code>
 *
 * Optionally you may wish to check if your API key is valid as in the example below.
 *
 * <code>
 * $akismet = new Akismet('http://www.example.com/blog/', 'aoeu1aoue');
 *
 ...
 *
 * The code that makes up this class originates in the Akismet NGCMS plugin, which is {@link http://akismet.com/download/ available on the Akismet website}.
 *
