<form method="post" id="commit_delete" action="admin.php?mod=extra-config&amp;plugin=category_access&amp;action=dell_user">
	<input type="hidden" name="user" value="{user}"/>
	<input type="hidden" id="commit" name="commit" value="no"/>
	<div align="center"><font color="red" size="+2">{commit}</div>
