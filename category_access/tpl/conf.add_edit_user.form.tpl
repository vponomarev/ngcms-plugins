...
<tr>
<td width="50%" class="contentEntry1">{l_category_access:label_user_name}<br /><small>{l_category_access:desc_user}</small></td>
<td width="50%" class="contentEntry2">{user_list}</td>
</tr>
<tr>
<td width="50%" class="contentEntry1">{l_category_access:label_category}<br /><small>{l_category_access:desc_category}</small></td>
