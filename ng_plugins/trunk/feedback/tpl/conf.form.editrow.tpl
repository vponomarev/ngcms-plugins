...
<tr class="contRow1"><td width="50%">јвтозаполнение:<br/><small><b>Ќет</b> - пользователь должен самосто€тельно заполн€ть поле<br/><b>параметром</b> - значение пол€ может передаватьс€ в качестве параметра к URL'у вызова<br/><b>св€зкой с новостью</b> - значение пол€ может братьс€ из одноимЄнного пол€ плагина <b>xfields</b> св€занной новости<br/><b>св€зка с профилем</b> - значение пол€ может братьс€ из одноимЄнного пол€ плагина <b>xfields</b> профил€ пользовател€</small></td><td>
<select name="auto">
