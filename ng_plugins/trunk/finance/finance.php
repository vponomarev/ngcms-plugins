...
class FinanceNewsFilter extends NewsFilter {
	function addNewsForm(&$tvars) {
		$tvars['vars']['finance']  = '<tr><td width="100%" class="contentHead"><img src="'.admin_url.'/skins/default/images/nav.gif" hspace="8" alt="" />Платный доступ к новости</td></tr>';
		$tvars['vars']['finance'] .= '<tr><td width="100%" class="contentEntry1"><table><tr><td>Стоимость доступа:</td><td><input name="fin_price" /> <small>( в формате <b>xxx.xx</b>, если не указано, то доступ к новости бесплатен)</small></td></tr></table></td></tr>';
		return 1;
	}
	...
	function editNewsForm($newsID, $SQLold, &$tvars) {
		$tvars['vars']['finance']  = '<tr><td width="100%" class="contentHead"><img src="'.admin_url.'/skins/default/images/nav.gif" hspace="8" alt="" />Платный доступ к новости</td></tr>';
		$tvars['vars']['finance'] .= '<tr><td width="100%" class="contentEntry1"><table><tr><td>Стоимость доступа:</td><td><input name="fin_price" value="'.$SQLold['fin_price'].'" /> <small>( в формате <b>xxx.xx</b>, если не указано, то доступ к новости бесплатен)</small></td></tr></table></td></tr>';
		return 1;
	}
...
global $template, $username, $FINANCE_MONEY_ACCEPTORS;
	...
	$template['vars']['mainblock'] = '<div class="not_logged"><h3>Финансовая информация</h3><u>Ваш баланс</u>: $<font color="blue"><b>'.$ubalance.'</b></font>&nbsp;</b><br /><br /></div><br /><div class="not_logged">Выбор варианта пополнения счета: <ul>';
	foreach ($FINANCE_MONEY_ACCEPTORS as $acceptor) {
		if ($acceptor->active) {
