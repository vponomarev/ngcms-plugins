...
Параметры массива управляющего внесением изменений в структуру БД
...
if ($_REQUEST['action'] == 'commit') {
	...
	$text = "Плагин <b>finance</b> предоставляет базовые подпрограммы для управления финансами.<br />С использованием функций, предоставляемых данным плагином, можно реализовать механизмы оплаты контента, предоставления услуг и т.д.<br /><br />Внимание! При установке плагин производит изменения в БД системы!";
