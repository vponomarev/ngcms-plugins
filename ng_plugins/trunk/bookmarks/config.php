...
$cfg = array();
$cfgX = array();
array_push($cfg, array('descr' => 'Плагин позволяет пользователям вести свои собственные "закладки"'));
array_push($cfgX, array('name' => 'hideempty', 'title' => "Скрывать пустой блок", 'descr' => "<b>Нет</b> - отображать блок даже если у пользователя нет новостей в закладках<br /><b>Да</b> - отображать блок вне зависимости от наличия закладок в нём", 'type' => 'select', 'values' => array ( '1' => 'Да', '0' => 'Нет'), 'value' => intval(extra_get_param($plugin,'hideempty'))));
