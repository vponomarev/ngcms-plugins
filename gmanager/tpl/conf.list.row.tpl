...
<td>
	<input type="image" src="{admin_url}/skins/default/images/up.gif" onmousedown="javascript:window.location.href='{admin_url}/admin.php?mod=extra-config&plugin=gmanager&action=move_up&id={id}'"/>&#160;<input type="image" src="{admin_url}/skins/default/images/down.gif" onmousedown="javascript:window.location.href='{admin_url}/admin.php?mod=extra-config&plugin=gmanager&action=move_down&id={id}'"/>
</td>
<td>{name}</td>
<td>{title}</td>
<td>
